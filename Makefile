...
#    Updated: 2022/08/29 13:05:22 by joeduard         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES			=	cub3d.c
FILES			+=	event_handler.c exit_game.c game_utils.c get_next_line.c init_game.c \
					init_image.c init_window.c map_check.c map_render.c map_utils.c read_map.c \
					valid_map.c \ 
